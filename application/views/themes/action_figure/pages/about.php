...
<div class="hero-wrap hero-bread" style="background-image: url('<?php echo get_theme_uri('images/bg_1.jpg'); ?>');">
  ...
  <section class="ftco-section ftco-no-pb ftco-no-pt bg-light">
          <div class="container">
              <div class="row">
                  <div class="col-md-5 p-md-5 img img-2 d-flex justify-content-center align-items-center" style="background-image: url(<?php echo get_theme_uri('images/sugoi.png'); ?>);">
                      <a href="https://www.youtube.com/watch?v=5hGcGyEC77M" class="icon popup-vimeo d-flex justify-content-center align-items-center">
